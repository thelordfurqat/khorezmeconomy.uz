...
<head>
    ...
    <title>Iqtisodiyot va sanoat bosh boshqarmasi</title>
    <?php $this->head() ?>
</head>
        ...
        <div class="container" style="font-size: 14px;">
            <div class="row" style="font-size: 14px;">
                <div class="col-lg-8 lang-and-social-buttons">
                            ...
                            <a href="https://president.uz/" style="font-size: 14px;">Ўзбекистон Республикаси Президенти   </a>
                    <span>      |   </span>
                            <a href="https://gov.uz/" style="font-size: 14px;">   Ўзбекистон Республикаси Ҳукумати</a>

                </div>
                <div class="col-lg-4 lang-and-social-buttons pull-right" style="font-size: 14px;">
                        <form id="w0" class="top-search-form" action="/uz/site/search" method="GET" style="font-size: 14px;">                                        <input type="text" name="query" placeholder="Излаш..." required="required" style="font-size: 14px;">
            ...
            <div class="row" style="font-size: 14px;">
                <div class="col-lg-12">
                    <!-- Logo start -->
                        ...
                        <div class="row">
                            <div class="col-lg-1">
                                <a href="<?=Yii::$app->homeUrl?>" class="site-logo" style="font-size: 14px;">
                            ...
                            <div class="col-lg-4">
                                ...
                                <p  style="font-size: 28px; text-align: center">Хоразм вилояти <br style="font-size: 22px;"> Иқтисодиёт ва саноат<br> <span>  бош бошқармаси</span></p>
                                        ...
                                        <div class="row" style="align-items: center">
                                            <div class="col-lg-4 header-contacts-item hidden-sm hidden-xs" style="font-size: 14px;">
                                                <div class="title" style="font-size: 12.5px;">
                                                    <i class="fa fa-envelope" aria-hidden="true" style="font-size: 12.5px;"></i> Електрон почта</div>
                                                <div class="content" style="font-size: 16px;"><p >info@mineconomy.uz</p> </div>
                                            </div>
                                            <div class="col-lg-3 header-contacts-item" style="font-size: 14px;">
                                                <div class="title" style="font-size: 12.5px;">
                                                    <i class="fa fa-phone" aria-hidden="true" style="font-size: 12.5px;"></i> Ишонч телефони</div>
                                            ...
                                            <div class="col-lg-3 header-contacts-item social-networks-div" style="font-size: 14px;">
                                                ...
                                                <a href="https://www.facebook.com/mineconomy.uz" style="font-size: 14px;"> <img src="<?=Yii::$app->homeUrl?>static/facebook.jpg" style="font-size: 14px;"></a>
                                                <a href="http://davra.uz/pages/page/d7f5d7c1-7641-4a4c-ac6a-578dba4bb3ff" style="font-size: 14px;"> <img src="<?=Yii::$app->homeUrl?>static/davra.png" style="font-size: 14px;"></a>
                                                <a href="https://www.youtube.com/channel/UCYib8rCrsF7z2MmTPbnwjgg" style="font-size: 14px;"> <img src="<?=Yii::$app->homeUrl?>static/youtube.jpg" style="font-size: 14px;"></a>
                                                <a href="https://t.me/MineconomyUz" style="font-size: 14px;"> <img src="<?=Yii::$app->homeUrl?>static/telegram.jpg" style="font-size: 14px;"></a>
                                            </div>
                                        </div>
