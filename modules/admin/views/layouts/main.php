        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li class="<?= Yii::$app->controller->id == 'page' ? 'active' : ''?>">
                    <a href="#"><i class="fa fa-table"></i> <span class="nav-label">Statik sahifalar</span> <span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="<?= Yii::$app->urlManager->createUrl(['admin/page'])?>">Statik sahifalar ro'yhati</a></li>
                        <li ><a href="<?= Yii::$app->urlManager->createUrl(['admin/page/create'])?>">Statik sahifa qo'shish</a></li>
